...
from dataset import MultiwozKnowledge, MultiwozResponseGenerationDataset
...
def Train(args: Namespace,
          train_dataset: MultiwozResponseGenerationDataset,
          eval_dataset: MultiwozResponseGenerationDataset,
          model: MyModel):
...
def Evaluate(eval_dataset: MultiwozResponseGenerationDataset, model: MyModel) -> dict:
    with torch.no_grad():
        model.eval()
...
def main() -> None:
    ...
    val_dataset = MultiwozResponseGenerationDataset(
        args,
        my_model.tokenizer,
        multiwoz_knowledge,
